...
class SiamRPNBIG(nn.Module):
    ...
    def forward(self, x):
        ...
        #a = self.conv_r2(x_f)
        #b = F.conv2d(self.conv_r2(x_f), self.r1_kernel)
        #e = self.regress_adjust(b)
        #c = self.conv_cls2(x_f)
        #d = F.conv2d(self.conv_cls2(x_f), self.cls1_kernel)
        #print("F.conv2d( self.conv_r2(x_f) , self.r1_kernel )",F.conv2d( self.conv_r2(x_f) , self.r1_kernel ))
